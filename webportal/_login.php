...
<body class="p-5 mx-6 border-0 bd-example m-0 border-0 my-5 c bdy">
    ...
    <form action="_login.php" method="post" class="p-5 c rbb">
        <fieldset>
            <input class="lf mb-4 rbtb" type="email" id="usern" name="usern" onkeydown="return event.key != 'Enter';" placeholder=" Email">
            <input class="lf mb-4 rbtb" type="password" id="passw" name="passw" placeholder=" Password"><br>
            <button class="lf rbtb blrc" type="submit" name="login" >Login</button>
            <a href="_register.php">
...
if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST["login"])) {
    ...
    if($passw == '' || $email == '') 
    {
        echo '<script type="text/javascript"> alert("Username or password missing."); window.location="_login.php"; </script>'; // hate these sm
        exit;
    }
    ...
    echo '<script type="text/javascript"> alert("Username or password incorrect."); window.location="_login.php"; </script>';
    exit;
