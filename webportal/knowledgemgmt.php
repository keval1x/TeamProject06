...
<div class="sidebar">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item bg-dark text-light" onclick="openToDoList()">To-Do List</li>
    </ul>
</div>

<div class="container">
    <h1 class="text-center mb-4" style="color:#333;">Knowledge Management</h1>
